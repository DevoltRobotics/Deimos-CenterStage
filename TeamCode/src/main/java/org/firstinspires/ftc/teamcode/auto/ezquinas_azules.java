...
public class ezquinas_azules extends LinearOpMode {

    OpenCvWebcam webcam;
    BlueTeamElementDetectionPipeline pipeline;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence secuencia1 = mecanumDrive.trajectorySequenceBuilder(new Pose2d(-36.0, 59.0, Math.toRadians(270.0)))
               //en medio .lineToSplineHeading(new Pose2d(-35.0, 9.0, Math.toRadians(90)))
                .lineToSplineHeading(new Pose2d(-33.5, 30.0, Math.toRadians(0.0)))//poner en la izquierda
        ...
        TrajectorySequence secuencia2 = mecanumDrive.trajectorySequenceBuilder(new Pose2d(-36.0, 59.0, Math.toRadians(270.0)))
        ...
        TrajectorySequence secuencia3 = mecanumDrive.trajectorySequenceBuilder(new Pose2d(-36.0, 59.0, Math.toRadians(270.0)))
                .lineToSplineHeading(new Pose2d(-33.5, 30.0, Math.toRadians(180)))
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
                    Hardware.eskupidito();
                })
                .UNSTABLE_addTemporalMarkerOffset(2, () -> {
         ...
         */
        webcam.setPipeline(pipeline = new BlueTeamElementDetectionPipeline());
