...
@Autonomous (name = "rojos")
public class
alianza_roja extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        RedTeamElementDetectionPipeline pipeline = new RedTeamElementDetectionPipeline();
        ...
        mecanumDrive.setPoseEstimate(new Pose2d(-36.0, -59.0, Math.toRadians(90.0)));

        TrajectorySequence secuencia1 = mecanumDrive.trajectorySequenceBuilder(new Pose2d(-36.0, -59.0, Math.toRadians(90.0)))
                .waitSeconds(6)
